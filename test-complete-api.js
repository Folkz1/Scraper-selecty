/**
 * Teste COMPLETO de criação de currículo via API REST
 * Inclui: Experiência Profissional + Escolaridade
 */
...
const curriculumData = {
  // ─── DADOS PESSOAIS ───
  nome: `TESTE COMPLETO API ${timestamp}`,
  cpf: testCPF,
  email: `teste.completo.${timestamp}@email.com`,
  ...
  experiencias: [
    {
      ...
      occupation_id: '41211',  // ID de ocupação do Selecty
      name: 'Abastecedor',     // Nome da ocupação
      start: '01/03/2020',
      finish: '15/11/2023',
      current: 'no',
  ...
  // ─── OBSERVAÇÕES ───
  referencias: 'Currículo criado via API automatizada com experiência e formação.'
};

async function testComplete() {
  console.log('═'.repeat(60));
  console.log('🧪 TESTE COMPLETO VIA API (COM EXPERIÊNCIA + FORMAÇÃO)');
  console.log('═'.repeat(60));
  console.log('\n📋 Dados:');
